...
class AxiosHelper {
   ...
   */
  async requestAxiosResponse({method, path, params, query, data, headers, responseType}) {
    if (!path || !method) {
  ...
  async requestData({method, path, params, query, data, headers, responseType}) {
    const response = await this.requestAxiosResponse({method, path, params, query, data, headers, responseType});
